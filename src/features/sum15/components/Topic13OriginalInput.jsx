...
import { generateTopic13 } from '../utils/sum15Analyzer'

// 시선 topic (원형): SUM15 원형과 동일하되 영어 문장이 아닌 '구'로 약 13단어 주제만 생성
function Topic13OriginalInput({ text, setText, onProcess, apiKey }) {
      ...
      <form onSubmit={handleSubmit} className="input-form">
        <div className="form-section">
          ...
          <textarea
            ...
            disabled={isLoading}
          />
          <small>형식: 출처/영어원문/한글해석// (// 기준으로 여러 지문 입력 가능) · 글의 주제를 구(phrase)로 약 13단어 (원형)</small>
        </div>
...
export default Topic13OriginalInput
