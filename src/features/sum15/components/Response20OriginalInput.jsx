...
import { generateResponse20 } from '../utils/sum15Analyzer'

// 시선 response 20 (원형): SUM15 원형과 처리과정 동일, 글을 제대로 이해한 독자의 감상평을 약 20단어로 생성
function Response20OriginalInput({ text, setText, onProcess, apiKey }) {
      ...
      <form onSubmit={handleSubmit} className="input-form">
        <div className="form-section">
          ...
          <textarea
            ...
            disabled={isLoading}
          />
          <small>형식: 출처/영어원문/한글해석// (// 기준으로 여러 지문 입력 가능) · 독자 감상평 약 20단어 (원형)</small>
        </div>
...
export default Response20OriginalInput
