...
import { summarizeText } from '../utils/sum15Analyzer'

// SUM15 원형: SUM15와 동일하되 어법 변형 조건 없음 (보기 단어 그대로 사용)
function Sum15OriginalInput({ text, setText, onProcess, apiKey }) {
      ...
      <form onSubmit={handleSubmit} className="input-form">
        <div className="form-section">
          ...
          <textarea
            ...
            disabled={isLoading}
          />
          <small>형식: 출처/영어원문/한글해석// (// 기준으로 여러 지문 입력 가능) · 어법 변형 조건 없음</small>
        </div>
...
export default Sum15OriginalInput
